...
abstract class REST_Controller extends CI_Controller {
     ...
     * @return void
     */
    public function __construct($config = 'rest', $override = FALSE) //$override para saltarse la comprobación del token en el login
    {
        parent::__construct();
    ...
    protected function _check_token()
    {
        ...
        if (!$auth_token) {
            $auth_token = $this->input->get_request_header('X-Authorization', TRUE);
        }

        $is_valid = $this->_validate_token($auth_token);
